...
def regt1562_pid_0002_netntlm_downgrade_restrict_sending_ntlm_traffic(*, logic='mde', lookback='1d'):
    """
    NetNTLM Downgrade Attack
    ...
    if logic == 'mde':
        with open(os.path.join(mpath,
                               'regt1562_pid_0002_netntlm_downgrade_restrict_sending_ntlm_traffic.yaml'), 'r') as file:
            data = yaml.safe_load(file)
