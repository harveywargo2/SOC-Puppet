...
netsh_kql_path = os.path.join(netsh_path, 'kql_m365d')
netsh_sigma_path = os.path.join(netsh_path, 'sigma')


def netsh_p0001_set_firewall_profile_off(*, type='kql', kql_ago='1d'):
...
def netsh_p0003_file_signer_mismatch(*, type='kql', kql_ago='1d'):
...
def netsh_p1002_mod_firewall_service_add_rdp_rule(*, type='kql', kql_ago='1d'):
...
def netsh_p1004_add_rule(*, type='kql', kql_ago='1d'):
