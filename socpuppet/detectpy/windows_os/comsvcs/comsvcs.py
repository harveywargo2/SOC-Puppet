...
comsvcs_kql_path = os.path.join(comsvcs_path, 'kql_m365d')
comsvcs_sigma_path = os.path.join(comsvcs_path, 'sigma')


def comsvcs_p1000_created_minidump(*, type='kql', kql_ago='1d'):
...
def comsvcs_p1001_minidump_writedump_function_call(*, type='kql', kql_ago='1d'):
...
def comsvcs_p1002_created_file(*, type='kql', kql_ago='1d'):
