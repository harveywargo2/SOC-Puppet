...
net_kql_path = os.path.join(net_path, 'kql_m365d')
...
def net_p0002_created_file(*, type='kql', kql_ago='1d'):
...
def net_p0003_file_signer_name_mismatch(*, type='kql', kql_ago='1d'):
...
def net_p1000_list_domain_groups(*, type='kql', kql_ago='1d'):
...
def net_p1001_add_user_domain_group(*, type='kql', kql_ago='1d'):
...
def net_p1002_list_domain_admins_group_users(*, type='kql', kql_ago='1d'):
...
def net_p1003_add_user_domain_admins_group(*, type='kql', kql_ago='1d'):
...
def net_p1004_list_enterprise_admins_group_users(*, type='kql', kql_ago='1d'):
...
def net_p1005_add_user_enterprise_admins_group(*, type='kql', kql_ago='1d'):
...
def net_p1006_list_admins_group_users(*, type='kql', kql_ago='1d'):
...
def net_p1007_list_users_in_monitored_list_match(*, type='kql', kql_ago='1d'):
    word_list = "let KeywordList = dynamic(['server', 'service accounts', 'linux server', 'linux']);"
...
def net_p2000_list_local_groups(*, type='kql', kql_ago='1d'):
...
def net_p2001_add_user_to_local_group(*, type='kql', kql_ago='1d'):
...
def net_p2002_list_users_local_group_admins(*, type='kql', kql_ago='1d'):
...
def net_p2003_list_users_in_local_group_rdp(*, type='kql', kql_ago='1d'):
...
def net_p2004_add_user_to_local_group_admins(*, type='kql', kql_ago='1d'):
...
def net_p2005_add_user_to_local_group_rdp(*, type='kql', kql_ago='1d'):
...
def net_p3000_list_users_on_device(*, type='kql', kql_ago='1d'):
...
def net_p3001_list_domain_users(*, type='kql', kql_ago='1d'):
...
def net_p3002_list_details_of_admin_user(*, type='kql', kql_ago='1d'):
...
def net_p4000_view_visible_computers(*, type='kql', kql_ago='1d'):
...
def net_p4001_view_visible_computers_hidden_shares(*, type='kql', kql_ago='1d'):
...
def net_p4002_stop_defender_service(*, type='kql', kql_ago='1d'):
