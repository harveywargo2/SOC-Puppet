...
def mimikatz_pid_0014_av_hacktool_alert(*, logic='mde', lookback='1d'):
    """
    mimikatz command
    ...
    if logic == 'mde':
        with open(os.path.join(mpath,
                               'mimikatz_pid_0014_av_hacktool_alert.yaml'), 'r') as file:
            data = yaml.safe_load(file)
...
def mimikatz_pid_0015_av_hacktool_dynamic(*, logic='mde', lookback='1d'):
    """
    mimikatz command
    ...
    if logic == 'mde':
        with open(os.path.join(mpath,
                               'mimikatz_pid_0015_av_hacktool_dynamic.yaml'), 'r') as file:
            data = yaml.safe_load(file)
...
def mimikatz_pid_0016_av_hacktool_event(*, logic='mde', lookback='1d'):
    """
    mimikatz command
    ...
    if logic == 'mde':
        with open(os.path.join(mpath,
                               'mimikatz_pid_0016_av_hacktool_event.yaml'), 'r') as file:
            data = yaml.safe_load(file)
